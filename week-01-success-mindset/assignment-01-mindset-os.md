...
* Learning hours and technical skills developed
* Coding practice and problem-solving progress
* AI/ML concepts learned and applied
* Projects built, shipped, and documented
* GitHub contributions and portfolio growth
* Internships, certifications, and career milestones
* Deep work sessions and focused study time
* Sleep quality, physical activity, and energy levels
* Personal spending, saving, and financial discipline
* Networking, communication, and community contributions
